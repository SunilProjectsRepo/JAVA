...
/* 
 * Here, we are retrieving the results for the first task
 * then the second task and lastly the third task.
 * 
 * Blocking Technique - in which main thread blocks 
 * if the worker thread has not yet completed the task.
 */
